...
public class CheckedListFragment extends ListFragment implements CheckedItemArrayAdapter.ItemCheckedListener {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        if (mContextMenuEnabled) {
            ...
            if (adapter.getItem(position).getDevice().getDeviceType() == DeviceType.SWITCH) {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.menu_rename || itemId == R.id.menu_delete || itemId == R.id.menu_info) {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        if (!mClickEnabled) {
            ...
            listener.onItemSelected(this.getTag(), item.getDevice().getDeviceId());
        }
    }
    ...
    private void sortItems() {
        Collections.sort(itemList, new Comparator<CheckedListItem>() {
            @Override
            public int compare(CheckedListItem lhs, CheckedListItem rhs) {
                return lhs.getDevice().getName().compareToIgnoreCase(rhs.getDevice().getName());
            }
        });
    }
