...
#define HANDLE_HEART_RATE_SERVICE_END   (0x0012)
...
#define HANDLE_SWITCH_INTENSITY         (0x0012)
#define ATTR_LEN_SWITCH_INTENSITY       (1)
#define HANDLE_BATTERY_SERVICE          (0x0013)
#define HANDLE_BATTERY_SERVICE_END      (0x0016)
#define ATTR_LEN_BATTERY_SERVICE        (2)
#define HANDLE_BATT_LEVEL               (0x0015)
#define ATTR_LEN_BATT_LEVEL             (1)
#define HANDLE_BATT_LEVEL_C_CFG         (0x0016)
#define ATTR_LEN_BATT_LEVEL_C_CFG       (0)
#define HANDLE_DEVICE_INFO_SERVICE      (0x0017)
#define HANDLE_DEVICE_INFO_SERVICE_END  (0xffff)
#define ATTR_LEN_DEVICE_INFO_SERVICE    (2)
#define HANDLE_DEVICE_INFO_SERIAL_NUMBER (0x0019)
#define ATTR_LEN_DEVICE_INFO_SERIAL_NUMBER (19)
#define HANDLE_DEVICE_INFO_HARDWARE_REVISION (0x001b)
#define ATTR_LEN_DEVICE_INFO_HARDWARE_REVISION (4)
#define HANDLE_DEVICE_INFO_FIRMWARE_REVISION (0x001d)
#define ATTR_LEN_DEVICE_INFO_FIRMWARE_REVISION (14)
#define HANDLE_DEVICE_INFO_SOFTWARE_REVISION (0x001f)
#define ATTR_LEN_DEVICE_INFO_SOFTWARE_REVISION (14)
#define HANDLE_DEVICE_INFO_MANUFACTURER_NAME (0x0021)
#define ATTR_LEN_DEVICE_INFO_MANUFACTURER_NAME (7)
