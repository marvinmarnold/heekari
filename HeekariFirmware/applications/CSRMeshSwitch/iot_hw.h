...
/* The IOT board has 2 bottons and a toggle switch. The application uses 
 * the hardware to control the brightness levels and power state of
 * one destination group/device. So define the instance as 1.
 */
#define IOT_NUM_SWITCH_INSTANCES (1)
