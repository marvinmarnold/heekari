 ...
 */
#define CONNECTION_CID      g_switchapp_data.gatt_data.st_ucid
#define IS_BONDED           g_switchapp_data.gatt_data.bonded
#define CONN_CENTRAL_ADDR   g_switchapp_data.gatt_data.con_bd_addr
#define CONNECTION_IRK      g_switchapp_data.gatt_data.central_device_irk.irk
#define LINK_DIVERSIFIER    g_switchapp_data.gatt_data.diversifier
