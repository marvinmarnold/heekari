...
#define IS_BONDED           g_bridgeapp_data.gatt_data.bonded
#define CONN_CENTRAL_ADDR   g_bridgeapp_data.gatt_data.con_bd_addr
#define CONNECTION_IRK      g_bridgeapp_data.gatt_data.central_device_irk.irk
#define LINK_DIVERSIFIER    g_bridgeapp_data.gatt_data.diversifier
