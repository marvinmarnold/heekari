 ...
 *
 *  DESCRIPTION
 *      This file defines a simple implementation of CSRmesh bridge device
 *
 *****************************************************************************/
...
typedef struct
{
    ...
    /* When device is not connected, bridge to fast advertisement mode,
     * after idle time.
     */
    timer_id                       idle_tid;
...
typedef struct
{
    ...
    timer_id                       sm_device_id_advert_tid;

} CSRMESH_BRIDGE_DATA_T;
...
extern CSRMESH_BRIDGE_DATA_T g_bridgeapp_data;
