...
public abstract class BleProfileServiceReadyActivity<E extends BleProfileService.LocalBinder> extends Activity implements ScannerFragment.OnDeviceSelectedListener {
	...
	protected boolean onOptionsItemSelcted(final int itemId) {
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case R.id.action_about:
			...
			break;
		default:
			return onOptionsItemSelcted(id);
		}
		return true;
	}
	...
	public void onDeviceSelected(final BluetoothDevice device) {
		mLogSession = Logger.newSession(getApplicationContext(), getString(R.string.proximity_feature_title), device.getAddress(), device.getName());
